...
const AppContent = () => {
  ...
  React.useEffect(() => {
    console.log('Current theme in AppContent:', theme);
    if (theme === 'dark') {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300 ${theme === 'dark' ? 'dark' : ''}`}>
      {!isAdmin && (
